...
public class EvaluationContext {
    ...
    private static Sequence<Expression> defaultJavaImports() {
        return sequence(
                ...
                new Import("import java.net.*", "java.net.*"),
                new Import("import java.io.*", "java.io.*"),
                new Import("import java.util.concurrent.*", "java.util.concurrent.*"), 
                new Import("import java.awt.*", "java.awt.*"),
                new Import("import java.awt.event.*", "java.awt.event.*"),
                new Import("import javax.swing.*", "javax.swing"),
                new Import("import java.text.*", "java.text"),
                new Import("import java.nio.*", "java.nio.*"),
                new Import("import java.nio.channels.*", "java.nio.channels.*"),
                
                new Import("import java.nio.charset.*", "java.nio.charset.*"),
                new Import("import java.nio.file.*", "java.nio.file.*"),
                new Import("import java.util.logging.*", "java.util.logging"),
                new Import("import java.security.*", "java.security.*"),
                new Import("import java.security.cert.*", "java.security.cert"),
