...
public final class ConsoleConfig {
    ...
    public ConsoleConfig(Evaluator evaluator, Option<File> historyFile, 
            Sequence<String> expressions, ConsoleLogger logger,
            Sequence<Class<? extends Command>> commands, Sequence<Result> results, Boolean sandboxed) {
  ...
  public static ConsoleConfig consoleConfig(Evaluator evaluator) {
        return new ConsoleConfig(evaluator, none(File.class), empty(String.class), new ConsoleLogger(), defaultCommands(), empty(Result.class), false);
    }
