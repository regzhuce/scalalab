...
public class MatrixConv {
  ...
  //// convert double [][] to MTJ DenseMatrix
    ...
    public static double [][] AC2Matrix(org.apache.commons.math4.linear.Array2DRowRealMatrix  dm)     {
  ...
  // convert Apache Commons to Double Array
    public static double[][] AC2DoubleArray(org.apache.commons.math4.linear.Array2DRowRealMatrix  dm)     {
      int nr = dm.getRowDimension();
      int nc = dm.getColumnDimension();
      double [][] rm = new double[nr][nc];
      for (int r=0; r<nr; r++)
    ...
    public static org.apache.commons.math4.linear.Array2DRowRealMatrix   Matrix2AC(double [][] dm)     {
      int nr = dm.length;
      int nc = dm[0].length;
      org.apache.commons.math4.linear.Array2DRowRealMatrix  rm = new org.apache.commons.math4.linear.Array2DRowRealMatrix(nr, nc);
      for (int r=0; r<nr; r++)
          for (int c=0; c<nc; c++)
  ...
  //// convert double [][] to Apache Commons
    public static org.apache.commons.math4.linear.Array2DRowRealMatrix  DoubleArray2AC(double [][] dm)     {
      int nr = dm.length;
      int nc = dm[0].length;
      org.apache.commons.math4.linear.Array2DRowRealMatrix  rm = new org.apache.commons.math4.linear.Array2DRowRealMatrix(nr, nc);
      for (int r=0; r<nr; r++)
