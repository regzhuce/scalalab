...
import org.apache.commons.math4.complex.Complex   //  Apache Complex class
...
object Util
{
  ...
  import scala.collection.mutable.MutableList   //  MutableList class
 ...
 val out:Array[Complex] = new Array[Complex](lh.length)
  ...
  def freqz( b:Vec, a:Vec, n:Int, fS:Double ):(Array[Complex],Vec) =
  {
    ...
    import scalaSci.math.plot.plot._         //  DELETE
    import scalaSci.math.plot.plotTypes._    //  DELETE
