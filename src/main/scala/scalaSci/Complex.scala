...
final def /(divisor: Complex): Complex = {
  ...
  override final def equals(that : Any) = that match {
    ...
    override final def  hashCode(): Int  = {
        return 37 * (17 * org.apache.commons.math4.util.MathUtils.hash(im) +org.apache.commons.math4.util.MathUtils.hash(re))
    }
 ...
 final def  getArg() =  {
        org.apache.commons.math4.util.FastMath.atan2(Im, Re)
    }
