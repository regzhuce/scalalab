...
//// Apache FFT 
 ...
 final def FFT(sig: Vec):Array[org.apache.commons.math4.complex.Complex] =       FFT(sig.getv) 
  
 final def ifft(realffts: Array[Double], imffts: Array[Double]):Array[Double] =  scalaSci.FFT.FFTScala.ifft(realffts, imffts)

 final def IFFT(sig: Array[org.apache.commons.math4.complex.Complex]): Array[org.apache.commons.math4.complex.Complex] = {
    scalaSci.FFT.ApacheFFT.ifft(sig)
  }

 final def getReParts(sig: Array[org.apache.commons.math4.complex.Complex]) = {
   scalaSci.FFT.FFTCommon.getReParts(sig)
 }

 final def getImParts(sig: Array[org.apache.commons.math4.complex.Complex]) = {
...
final def asvd(x: RichDoubleDoubleArray): SvdResults = {
  ...
  final def  aqr(x: Array[Array[Double]] ): QRResults =  {
    ...
    var  qrObj = new org.apache.commons.math4.linear.QRDecomposition(rx)
